...
interface IMovieService
{
    ...
    suspend fun AddAsync(name: String, overview: String, posterUrl: String?): Some<Int>
    suspend fun UpdateAsync(dtoModel: MovieDto): Some<Int>;
    suspend fun RemoveAsync(dtoId: Int): Some<Int>;
