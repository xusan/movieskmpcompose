...
class MockMovieRestService : IMovieRestService
{
    ...
    {
        val result = jsonSerializer.decodeFromString<MovieListResponse>(movieJson)
        delay(600)//some delay to mock loading
