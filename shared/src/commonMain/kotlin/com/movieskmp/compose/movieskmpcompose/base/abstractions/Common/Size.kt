...
class Size
{
    ...
    {
        if (width.isNaN()) throw IllegalArgumentException("NaN is not a valid value for width")
        if (height.isNaN()) throw IllegalArgumentException("NaN is not a valid value for height")
        _width = width
        _height = height
    }
    ...
    var Width: Double
        ...
        set(value)
        {
            if (value.isNaN()) throw IllegalArgumentException("NaN is not a valid value for Width")
            _width = value
        }
    ...
    var Height: Double
        ...
        set(value)
        {
            if (value.isNaN()) throw IllegalArgumentException("NaN is not a valid value for Height")
            _height = value
        }
